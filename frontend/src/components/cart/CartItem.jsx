...
const CartItem = ({ item }) => {
  ...
  const productImage = item.image || product.image || '/src/assets/images/placeholder-product.png';
  const unitPrice = (item.priceCents ?? item.price ?? product.priceCents ?? product.price) || 0;
